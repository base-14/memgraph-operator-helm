...
{{- default (include "memgraph-operator.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "memgraph-operator.clusterRoleName" -}}
{{- printf "%s-manager-role" (include "memgraph-operator.fullname" .) }}
{{- end }}
